...
<div id="page">
    ...
    <div id="fh5co-project">
        ...
        <div class="project-content">
            <div class="col-forth">
                <div class="project animate-box" style="background-image:url(${pageContext.request.contextPath}/images/project-8.jpg);">
                    <a href="#" class="desc">
            ...
            <div class="col-forth">
                <div class="project animate-box" style="background-image:url(${pageContext.request.contextPath}/images/project-1.jpg);">
                    <a href="#" class="desc">
                        <span>Application</span>
                        <h3>Project Name</h3>
                    </a>
            ...
            <div class="col-forth">
                <div class="project animate-box" style="background-image:url(${pageContext.request.contextPath}/images/project-2.jpg);">
                    <a href="#" class="desc">
                        <span>Application</span>
                        <h3>Project Name</h3>
                    </a>
            ...
            <div class="col-forth">
                <div class="project animate-box" style="background-image:url(${pageContext.request.contextPath}/images/project-3.jpg);">
                    <a href="#" class="desc">
                        <span>Application</span>
                        <h3>Project Name</h3>
                    </a>
